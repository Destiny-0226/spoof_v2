...
struct kvm_vcpu_arch {
	...
	u16 ovo_msr_overlay_n;
	u32 ovo_msr_overlay_idx[256];
	u64 ovo_msr_overlay_val[256];
...
struct kvm_vcpu_stat {
	...
	u64 cpuid_fastpath;
	u64 cpuid_fastpath_fallback;
	u64 cpuid_inner_fastpath;
	u64 cpuid_inner_cache_miss;
	u64 cpuid_inner_blockers;
	u64 cpuid_inner_rfds_skip_armed;
	u64 cpuid_inner_early_armed;
	u64 cpuid_dynamic_generation;
	u64 cpuid_profile_samples;
	u64 cpuid_profile_validation_cycles;
	u64 cpuid_profile_lookup_cycles;
	u64 cpuid_profile_rip_cycles;
	u64 cpuid_profile_resume_cycles;
	u64 cpuid_profile_transition_samples;
	u64 cpuid_profile_transition_cycles;
	u64 cpuid_profile_transition_min_cycles;
	u64 cpuid_profile_transition_max_cycles;
	u64 cpuid_profile_vmcs_valid;
	u64 cpuid_profile_vm_exit_msr_store_count;
	u64 cpuid_profile_vm_exit_msr_load_count;
	u64 cpuid_profile_vm_entry_msr_load_count;
	u64 cpuid_profile_vm_exit_controls;
	u64 cpuid_profile_vm_entry_controls;
	u64 cpuid_profile_primary_exec_controls;
	u64 cpuid_profile_secondary_exec_controls;
	u64 cpuid_profile_state_samples;
	u64 cpuid_profile_state_active_mask;
	u64 cpuid_profile_state_equal_mask;
	u64 cpuid_profile_state_perf_active_samples;
	u64 cpuid_profile_state_perf_equal_samples;
	u64 cpuid_profile_state_pat_active_samples;
	u64 cpuid_profile_state_pat_equal_samples;
	u64 cpuid_profile_state_efer_active_samples;
	u64 cpuid_profile_state_efer_equal_samples;
	u64 cpuid_profile_state_cet_active_samples;
	u64 cpuid_profile_state_cet_equal_samples;
	u64 cpuid_profile_state_guest_perf_global_ctrl;
	u64 cpuid_profile_state_host_perf_global_ctrl;
	u64 cpuid_profile_state_guest_pat;
	u64 cpuid_profile_state_host_pat;
	u64 cpuid_profile_state_guest_efer;
	u64 cpuid_profile_state_host_efer;
	u64 cpuid_profile_state_guest_s_cet;
	u64 cpuid_profile_state_host_s_cet;
	u64 cpuid_profile_state_guest_ssp;
	u64 cpuid_profile_state_host_ssp;
	u64 cpuid_profile_state_guest_intr_ssp_table;
	u64 cpuid_profile_state_host_intr_ssp_table;
};
